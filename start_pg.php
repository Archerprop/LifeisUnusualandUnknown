...
<body>
  ...
  <div class="vacio" id="particles-js">
    <div id="menu">
      ...
      <a class="navbar-brand" href="#">SimpleIntelligentAssistant</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="websites/musica.html">Musica</a>
          <a class="dropdown-item" href="websites/danza.html">Danza</a>
          <a class="dropdown-item" href="websites/juegos.html">Juegos</a>
          <a class="dropdown-item" href="websites/red_social.html">Redes sociales</a>
        </div>
      </li>
      <li class="nav-item">
 ...
 <script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_ES/sdk.js#xfbml=1&version=v3.2"></script>
  ...
  <div id="container">
    <div id="body">
      ...
      <ul>
      <li><p class="text_p">musica</p></li>
      <li><p class="text_p">juegos</p></li>
